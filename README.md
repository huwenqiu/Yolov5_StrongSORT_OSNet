...
This repository contains a highly configurable two-stage-tracker that adjusts to different deployment scenarios. The detections generated by [YOLOv5](https://github.com/ultralytics/yolov5), a family of object detection architectures and models pretrained on the COCO dataset, are passed to [OCSORT](https://github.com/dyhBUPT/StrongSORT)[](https://arxiv.org/abs/2203.14360) which uses motion information in order to tracks the objects. It can track any object that your Yolov5 model was trained to detect.
...
```latex
@misc{yolov5-ocsort-2022,
    title={Real-time multi-camera multi-object tracker using YOLOv5 and OCSORT},
